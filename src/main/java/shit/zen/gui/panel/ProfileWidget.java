            ...
            Renderer.renderConsumer(drawContext -> {
                if (this.hoverAlpha > 0.01f) {
                    ...
                    drawContext.drawRoundedRect(
                            RoundedRectangle.ofXYWHR(avatarX - 2, avatarY - 2, avatarSize + 4, avatarSize + 4, cornerRadius + 1.0f),
                            new Paint().setColor(hoverColor));
                }
                ...
                drawContext.drawRoundedRect(
                        RoundedRectangle.ofXYWHR(roleBoxX - 1.0f * scale, roleBoxY - 1.0f * scale, roleBoxW + 2.0f * scale, roleBoxH + 2.0f * scale, 5.0f * scale),
                        new Paint().setColor(this.applyAlpha(roleShadowColor, alpha * 0.35f)));
                drawContext.drawRoundedRect(
                        RoundedRectangle.ofXYWHR(roleBoxX, roleBoxY, roleBoxW, roleBoxH, 4.0f * scale),
                        new Paint().setColor(this.applyAlpha(roleColor.getRGB(), alpha)));
