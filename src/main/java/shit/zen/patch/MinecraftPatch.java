...
public class MinecraftPatch {
    ...
    @Inject(method = "setLevel", desc = "(Lnet/minecraft/client/multiplayer/ClientLevel;Lnet/minecraft/client/gui/screens/ReceivingLevelScreen$Reason;)V")
    public static void onSetLevel(Minecraft minecraft, ClientLevel level, ReceivingLevelScreen.Reason reason, CallbackInfo callbackInfo) {
        if (ZenClient.isReady()) {
