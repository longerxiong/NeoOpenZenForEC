...
public class BlockPatch {
    @Inject(
            ...
            desc = "(Lnet/minecraft/world/level/BlockGetter;Lnet/minecraft/core/BlockPos;Lnet/minecraft/world/level/block/state/BlockState;Lnet/minecraft/world/level/block/state/BlockState;Lnet/minecraft/core/Direction;)Z",
            at = @At(At.Type.HEAD)
    )
    public static void onShouldRenderFace(BlockGetter level, BlockPos pos, BlockState state,
