...
public final class GlHelper {
    ...
    public static void drawPlayerHeadRounded(AbstractClientPlayer player, float x, float y, float width, float height, float alpha, float radius) {
        ...
        drawContext.drawRoundedTexture(resourceLocation, bounds, packedColor, baseU1, baseV1, baseU2, baseV2);
        drawContext.drawRoundedTexture(resourceLocation, bounds, packedColor, hatU1, hatV1, hatU2, hatV2);
