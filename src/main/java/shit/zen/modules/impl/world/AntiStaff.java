...
public class AntiStaff extends Module {
    ...
    public void onPacket(PacketEvent packetEvent) {
        ...
        } else if (packet instanceof ClientboundAddEntityPacket clientboundAddPlayerPacket && clientboundAddPlayerPacket.getType() == EntityType.PLAYER) {
            if (mc.level != null) {
                net.minecraft.world.entity.Entity entity = mc.level.getEntity(clientboundAddPlayerPacket.getId());
                if (entity != null) {
