...
//            mc.player.getInventory().selected = this.prevSelectedSlot;
            mc.player.getInventory().setSelectedSlot(this.prevSelectedSlot);
        ...
        if (mc.player.getHealth() <= this.health.getValue().floatValue() && soupSlot != -1) {
            boolean alreadySelected = mc.player.getInventory().getSelectedSlot() == soupSlot;
            if (!alreadySelected) {
                this.prevSelectedSlot = mc.player.getInventory().getSelectedSlot();
