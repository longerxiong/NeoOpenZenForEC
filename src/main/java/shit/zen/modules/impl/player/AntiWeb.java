...
public class AntiWeb extends Module {
    ...
    public void onDisable() {
        ...
        if (this.savedHotbarSlot != -1 && mc.player != null) {
            mc.player.getInventory().setSelectedSlot(this.savedHotbarSlot);
        ...
        switch (currentPhase) {
            ...
            case PLACING -> {
                ...
                PacketUtil.sendQueued(new ServerboundMovePlayerPacket.Rot(
                        targetRotation.getYaw(), targetRotation.getPitch(), mc.player.onGround(), mc.player.horizontalCollision));
