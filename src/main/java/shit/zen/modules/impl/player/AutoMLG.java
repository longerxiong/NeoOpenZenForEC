...
extends Module {
    ...
    public void onTick(TickEvent tickEvent) {
        ...
        if (mc.player.onGround() || mc.player.getAbilities().flying || mc.player.isInWaterOrRain() || mc.player.isInLava()) {
            this.accumulatedFall = 0.0f;
        } else {
...
//            mc.player.getInventory().selected = this.slotToRestore;
            mc.player.getInventory().setSelectedSlot(this.slotToRestore);
            this.slotToRestore = null;
        }
    ...
    private void selectSlot(int slot) {
        this.slotToRestore = mc.player.getInventory().getSelectedSlot();
