...
implements IHudElement {
    ...
    public void renderGui(GuiGraphics guiGraphics, PoseStack poseStack, float x, float y, float width, float height, float alpha) {
        ...
        for (int i = 0; i < players.size(); ++i) {
            ...
            guiGraphics.blit(RenderPipelines.GUI_TEXTURED, skinTexture, (int)entryX, (int)rowWidth, 8.0f, 8.0f, 8, 8, 8, 8, 64, 64);
            guiGraphics.blit(RenderPipelines.GUI_TEXTURED, skinTexture, (int)entryX, (int)rowWidth, 40.0f, 8.0f, 8, 8, 8, 8, 64, 64);
        }
    }
