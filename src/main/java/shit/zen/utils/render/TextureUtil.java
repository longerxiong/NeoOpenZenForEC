...
public final class TextureUtil {
    ...
    public static DynamicTexture loadTexture(String fileName) {
        ...
        if (dynamicTexture == null) {
            try (FileInputStream fileInputStream = new FileInputStream(file)){
                ...
                dynamicTexture = new DynamicTexture(() -> "openzen/" + fileName, nativeImage);
    ...
    private static DynamicTexture getMissingTexture() {
        ...
        if (dynamicTexture == null) {
            ...
            nativeImage.setPixel(0, 0, -65281);
            nativeImage.setPixel(1, 0, -16777216);
            nativeImage.setPixel(0, 1, -16777216);
            nativeImage.setPixel(1, 1, -65281);
            dynamicTexture = new DynamicTexture(() -> "openzen/missing_texture", nativeImage);
