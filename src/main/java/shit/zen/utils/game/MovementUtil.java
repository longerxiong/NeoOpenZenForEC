...
extends ClientBase {
    ...
    public static void setSpeed(double speed) {
        float forward = mc.player.input.getMoveVector().x;
        float strafe = mc.player.input.getMoveVector().y;
        float yaw = mc.player.getYRot();
    ...
    public static boolean isInputActive() {
        return mc.player != null && mc.level != null && ((double)mc.player.input.getMoveVector().x != 0.0 || (double)mc.player.input.getMoveVector().y != 0.0);
    }
